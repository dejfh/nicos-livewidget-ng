...
public:
		...
		ValidationProgress &progress, Container<ResultElementType, ResultDimensionality> *recycle) const
	{
		...
		Container<ResultElementType, ResultDimensionality> result = filter::makeMutableContainer(sizes, recycle);
...
public:
		...
		ValidationProgress &progress, Container<ResultElementType, ResultDimensionality> *recycle) const
	{
		...
		Container<QMap<QString, QString>> result = filter::makeMutableContainer(ndim::Sizes<0>(), recycle);
